...
import Skills from '../smallComp/Skills'
import Box from '../smallComp/Box'
import Socials from '../smallComp/Socials'
...
const Home = () => {
  return (
    ...
    <div className="md:w-1/3 m-auto">
      ...
      <div className="flex justify-center mt-56 text-gray-500">
